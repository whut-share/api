...
import { MinterCheckoutSession, MinterCheckoutSessionDocument, User, TUserDocument } from '@/schemas';
...
@Injectable()
export class MinterCheckoutsStripeListenerService {


  constructor(
    @InjectModel(MinterCheckoutSession.name) 
    private da_checkout_session: Model<MinterCheckoutSessionDocument>,
